...
* **Background:** ... (these are items you'll need to adapt to your system's hardware & network)
    + NIC 1 is an Intel I211 seen as "enp6s0" with IPv4 address 192.168.2.1/18
    + NIC 2 is a Realtek RTL8125 seen as "enp7s0" with IPv4 address 192.168.3.1/18
    + Gateway is 192.168.1.1/18
