...
While I have tested these directions multiple times on fresh installs **on my own system**, *I can't verify everything on* ***your system***. 

If you run into something specifically wrong with the information I've posted, *please [add an Issue](https://github.com/Jahfry/Miscellaneous/issues)*. This guide may get posted to other sites like Reddit and it will be helpful to not need to track all links. 
