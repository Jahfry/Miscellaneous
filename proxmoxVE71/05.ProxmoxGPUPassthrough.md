...
* > 05 - Proxmox GPU Passthrough (***this page***)
    ...
    + [05.D. Install and Configure 'driverctl'](#05d-install-and-configure-driverctl)
        ...
        - [05.C.ii. Reverting 'drivertctl' Overrides](#05dii-reverting-driverctl-overrides)
...
## 05.C. Install and configure 'driverctl'
...
### 05.C.ii. Reverting 'drivertctl' Overrides
