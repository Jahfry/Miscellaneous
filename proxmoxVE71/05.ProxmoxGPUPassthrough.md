...
* ***Open [hookscript-driverctl.pl](https://raw.githubusercontent.com/Jahfry/Miscellaneous/main/proxmoxVE71/hookscript-driverctl.pl)***  *in a new browser window*
...
* In a shell do this: `qm set <vmid> -hookscript local:snippets/hookscript-driverctl.pl`  
    Example: `qm set 100 -hookscript local:snippets/hookscript-driverctl.pl`
