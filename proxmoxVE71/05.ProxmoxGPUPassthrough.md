...
* [Proxmox PCI Switcher]([rosineygp/proxmox-pci-switcher: Switch among Guest VMs organized by Resource Pool (github.com)](https://github.com/rosineygp/proxmox-pci-switcher)) ... a Python *alternative* to my hookscript. 
