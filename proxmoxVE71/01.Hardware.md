...
* Motherboard - 'Gigabyte Aorus X570 Master rev 1' [link](https://www.gigabyte.com/us/Motherboard/X570-AORUS-MASTER-rev-10) ... **not** X570S
    ...
    + Important BIOS Settings
        ...
        - *If you have multiple GPUs*, set which one is used for boot video. For instance I use my "little GPU" (GTX 1060) in PCIE slot 2 for boot video. I later force the Virtual Terminal to use the second GPU for video, so all system video can be seen here during boot. 
