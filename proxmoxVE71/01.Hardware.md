...
* 02 - Hardware (***this page***)
    + [02.A. Hardware Used](#02a-hardware-used)
    + [02.B. RAM Timings](#02b-ram-timings)
        - [02.B.i. Many Warnings](#02bi-many-warnings)
        - [02.B.ii. More Thoughts and Info](#02bii-more-info-and-thoughts)
        - [02.B.iii. RAM Heat Spreaders](#02biii-ram-heat-spreaders)
        - [02.B.iv. BIOS Settings](#02biv-bios-settings)
* > [03 - Proxmox Install](02.ProxmoxInstall.md)  (*next page*)
...
### 02.B.ii. More Info and Thoughts
...
>
> \< PREV: [00 - Introduction](00.Introduction.md)
