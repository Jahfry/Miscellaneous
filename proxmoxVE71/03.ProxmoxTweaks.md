...
* *Remove the "No Subscription" popups*
    ...
    + Dannyda's script
        - Keep a copy of the original file: `cp /usr/share/javascript/proxmox-widget-toolkit/proxmoxlib.js /usr/share/javascript/proxmox-widget-toolkit/proxmoxlib.js.orig`
        ...
        - [Go to the script page](https://dannyda.com/2020/05/17/how-to-remove-you-do-not-have-a-valid-subscription-for-this-server-from-proxmox-virtual-environment-6-1-2-proxmox-ve-6-1-2-pve-6-1-2/) to install it ... *Multiple versions listed, use the right version ("6.4-6 through 7.1-12 and up" as of this writing), paste the command into a shell
