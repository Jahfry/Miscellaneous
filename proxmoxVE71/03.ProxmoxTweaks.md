...
* > 03 - Proxmox Tweaks (***this page***)
    ...
    + [03.D. Minimizing SSD Wear](#03d-minimizing-ssd-wear)
        - [03.D.i. Disable Proxmox High Availability Services](#03di-disable-proxmox-high-availability-services)
        - [03.D.ii. log2ram - Move Frequently Written Files to RAM](#03dii-log2ram---move-frequently-written-files-to-ram)
            * [03.D.ii.a. initial install](#03diia-initial-install)
            * [03.D.ii.b. moving other stuff to RAM](#03diib-moving-other-stuff-to-ram)
    + [03.E. Fix Missing Drivers](#03e-fix-missing-drivers)
        - [03.E.i. 'regulatory.db'](#03ei-regulatorydb)
        - [03.E.ii. FAILED fixes for 'iwlwifi' and 'thermal_zone2'](#03eii-failed-fixes-for-iwlwifi-and-themal_zone2)
...
### 03.D.i. Disable Proxmox High Availability Services
...
### 03.D.ii. log2ram - Move Frequently Written Files to RAM
...
#### 03.D.ii.b. moving other stuff to RAM
