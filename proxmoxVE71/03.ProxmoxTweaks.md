...
- First make a copy of the original file:  
	...
	* The install below creates a backup file 'proxmoxlib.js.backup'
		* If you apply the change twice for whatever reason before Proxmox has replaced it with the original version, the backup will just be the modified file
