...
* Change 'LOG_DISK_SIZE=100M' to 'LOG_DISK_SIZE=1000M'
    + Done to match the increase in RAM use. I'm not 100% sure this needed to be done, have filed a [question against it](https://github.com/azlux/log2ram/issues/188), will update depending on what I hear back. 
