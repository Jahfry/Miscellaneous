...
Sources I pulled various information from:
...
**NOTE:** The README for log2ram mentions a config option for 'RSYNC', this is an older version option. Current version of log2ram will just use rsync if it is available, which it is by default on Proxmox VE. I've filed and issue for the maintainer to look at the README contents. 
