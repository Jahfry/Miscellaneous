...
* Boot to your installation image, probably the .iso on a USB ... **make sure this is the first boot device in your BIOS**
* 'Install Proxmox VE'
...
* Preparing the SSD
    ...
    + The 2 commands below are actually redundant, but I've used both, you can probably just use the first
        ...
        - Press [control]+[alt]+F3 to get a Virtual Terminal shell
        - `wipefs -a /dev/sdb`
        - `blkdiscard /dev/sdb`
